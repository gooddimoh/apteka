...
class PharmacyController extends Controller {
    ...
    public function index()
    {
        ...
        return view('admin.type1.main.index');
    }
    ...
    public function main()
    {
        ...
        $pharmacy = LoanApplication::with('status', 'analyst', 'cfo')->get();
        $defaultStatus = Status::find(1);
        $user = auth()->user();

        return view('admin.pharmacy.index', compact('pharmacy', 'defaultStatus', 'user'));
    }
    ...
    public function edit(LoanApplication $loanApplication)
    {
        ...
        return view('admin.pharmacy.edit', compact('statuses', 'loanApplication'));
    }
    ...
    public function show(LoanApplication $loanApplication)
    {
        ...
        return view('admin.pharmacy.show', compact('loanApplication', 'defaultStatus', 'user', 'logs'));
    }
    ...
    public function showSend(LoanApplication $loanApplication)
    {
        ...
        return view('admin.pharmacy.send', compact('loanApplication', 'role', 'users'));
    }
    ...
    public function send(Request $request, LoanApplication $loanApplication)
    {
        ...
        return redirect()->route('admin.pharmacy.index')->with('message', 'Loan application has been sent for analysis');
    }
    ...
    public function showAnalyze(LoanApplication $loanApplication)
    {
        ...
        return view('admin.pharmacy.analyze', compact('loanApplication'));
    }
    ...
    public function analyze(Request $request, LoanApplication $loanApplication)
    {
        ...
        return redirect()->route('admin.pharmacy.index')->with('message', 'Analysis has been submitted');
    }
}
